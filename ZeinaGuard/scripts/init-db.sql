...
-- Optimized for TimescaleDB usage
...
-- Sensor Health (Time-Series Data - Hypertable compatible)
CREATE TABLE IF NOT EXISTS sensor_health (
    ...
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id, created_at) -- Partition column must be in primary key for hypertables
);
...
CREATE TABLE IF NOT EXISTS network_topology (
    ...
    discovered_networks JSONB, -- Using JSONB for performance
...
-- Threat Events (Time-Series - Hypertable compatible)
CREATE TABLE IF NOT EXISTS threat_events (
    ...
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id, time) -- Partition column must be in primary key for hypertables
);
